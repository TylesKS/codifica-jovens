...
const images = [
  ...
  { id: 2, src: "/turmainiciosetembro1.jpg", alt: "Foto do dia 27/09 de Setembro. Aula de Realidade Virtual e Aumentada", credit: "Victor" },
  { id: 3, src: "/turmainiciosetembro.jpg", alt: "Descrição da imagem 3", credit: "Victor" },
...
function ImageGallery() {
  ...
  return (
    <div 
      id="gallery"
      className="relative w-full max-w-3xl mx-auto my-12 z-30 group mt-50"
    ...
    >
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 p-4 animate-fadeIn" onClick={closeModal}>
          <div className="bg-gray-900/80 ring-1 ring-white/10 rounded-lg p-4 relative max-w-4xl w-full" onClick={(e) => e.stopPropagation()}>
            {/* VISUAL MODERNO: Novo botão de fechar */}
            <button 
              onClick={closeModal} 
