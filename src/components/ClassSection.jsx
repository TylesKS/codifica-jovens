function ClassSection() {
  return (
    <div>
      <section className="mt-40 relative z-10 h-[100%] w-full">
        <div className="p-4">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <div className="grid grid-cols-2 grid-rows-11 gap-2">
              <div className="row-span-6 justify-center flex items-center">
                <img src="example2.png" alt="Professor Cleber" className="max-sm:mt-40"></img>
              </div>
              ...
              <div className="col-start-1 row-start-8">
                <div className="flex w-[50%] max-sm:w-[90%] mx-auto justify-between">
                  <div className="">Professor de Office: Word e Lógica de Programação</div>
                  <div className=""></div>
                </div>
              </div>
              ...
              <div className="col-start-1 row-start-11">
                <div className="w-[50%] max-sm:w-[90%] mx-auto relative group cursor-pointer p-1">
                  <a href="/LogicadeProgramação30-08.rar" download="LogicadeProgramação30-08.rar" className="">
              ...
              <div className="row-span-6 col-start-2 row-start-1 justify-center flex items-center max-sm:mt-40">
                <img src="/example1.png" alt="Professora Rose"></img>
              </div>
              ...
              <div className="col-start-2 row-start-8">
                <div className="flex w-[50%] max-sm:w-[90%] mx-auto justify-between">
                  <div className="">Professora de Robótica e Realidade Virtual e Aumentada</div>
                  <div className=""></div>
                </div>
              </div>
              <div className="col-start-2 row-start-9">
                <div className="w-[50%] max-sm:w-[90%] mx-auto relative group cursor-pointer p-1">
                  <a href="/Robotica06-09.rar" download="Robotica06-09.rar" className="">
                  <div className="flex justify-between w-full hover:text-[var(--color)] transition-colors duration-300">
